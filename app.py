...
if data['loaded']:
    ...
    # Option to initialize the pipeline
    if st.button("Initialize Data Pipeline"):
        with st.spinner("Initializing data pipeline..."):
            ...
            try:
                ...
                try:
                    ...
                    pipeline.preprocess_consumption_data(halfhourly=True, sample_size=100000)  # Use sample for testing
                    
                    st.success("Data processing complete! Please refresh the page.")
                except Exception as e:
